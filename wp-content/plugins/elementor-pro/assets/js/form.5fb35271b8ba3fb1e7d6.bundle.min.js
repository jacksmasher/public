      ...
      t.default = elementorModules.frontend.handlers.Base.extend({
        ...
        onSuccess(e) {
          ...
          if (
            ...
            elementorFrontendConfig.experimentalFeatures.e_font_icon_svg &&
              (s += " elementor-message-svg"),
          ...
          this.elements.$form.on({
            ...
            keydown: (t) => {
              if (
                ...
                t.preventDefault();
                const s =
                  t.target.closest(e.button)?.dataset?.direction || "next";
                this.applyStep(s);
              }
            },
