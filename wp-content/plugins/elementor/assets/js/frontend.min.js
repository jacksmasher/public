      ...
      class _default extends elementorModules.ViewModule {
        ...
        trackStickyElements(e, t) {
          e.forEach((e) => {
            ...
            t.push({ scrollMarginTop: o, type: "sticky", scrollPosition: s });
          });
        }
        ...
        defineCurrentStickyRange(e, t, n, o) {
          ...
          e.anchor = o.filter((t) => {
            const n =
              t.scrollPosition > e.scrollPosition && t.scrollPosition < s;
            return (
        ...
        style: {
          ...
          "e-lightbox": {
            src: elementorFrontendConfig?.responsive?.hasCustomBreakpoints
              ? `${elementorFrontendConfig.urls.uploadUrl}/elementor/css/custom-lightbox.min.css?ver=${s}`
              : `${n}css/conditionals/lightbox${o}.css?ver=${s}`,
          },
          dialog: {
